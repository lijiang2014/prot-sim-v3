  ...
  setup(props,{emit}) {
    ...
    const tiny = reactive({
      ...
      init: {
        ...
        toolbar: [
          "bold italic numlist fullscreen undo redo restoredraft | forecolor backcolor underline strikethrough  | alignleft aligncenter alignright alignjustify outdent indent lineheight",
          "styleselect formatselect fontselect fontsizeselect | image code ",
        ], //工具栏配置，设为false则隐藏
