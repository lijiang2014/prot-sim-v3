            ...
            <el-collapse v-model="activeNames" @change="changedActive">
                <el-collapse-item title="基本信息" name="基本信息" class="collapse-item">
                    <div class="base-info">
                        ...
                        <div class="time">
                            <div>提交时间：<span class="item-info">{{ baseInfo.created_at }}</span></div>
                            <div>开始时间：<span class="item-info">{{ baseInfo.started_at }}</span></div>
                            <div>结束时间：<span class="item-info">{{ baseInfo.end_at }}</span></div>
                        </div>
                        <div></div>
                        <div></div>
                        <div>运行状态：<span class="item-info">{{ baseInfo.status }}</span></div>
                    </div>
                </el-collapse-item>
...
import { listItem, result } from '@/app-model'
